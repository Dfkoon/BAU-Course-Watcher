# 🎓 نظام مراقبة جريدة المواد - جامعة البلقاء التطبيقية
### BAU Course Watcher
...
- 🎯 **فلترة مخصصة للطلاب:** إمكانية الاشتراك بمتابعة كليات محددة أو مواد معينة أو رقم شعبة خاص
- 🕒 **توقيت 12 ساعة واضح:** تحويل مواعيد الشعب المعقدة إلى توقيت 12 ساعة سلس مع تحديد طبيعة المادة (وجاهي / مدمج / إلكتروني)
- 🔐 **حماية وأمان عالي للأدمن (2FA TOTP):**
  - تسجيل دخول باستخدام اسم مستخدم وكلمة مرور مشفرة بـ `bcrypt`
  - مصادقة ثنائية `2FA TOTP` متوافقة مع تطبيق Google Authenticator وتطبيق Authy
  - صفحة إعدادات شاملة للأدمن لتغيير البيانات وتفعيل أو إيقاف الـ 2FA مع رمز QR تلقائي
- 📱 **واجهة مستجيبة بالكامل (Mobile & Desktop):** تصميم فاخر باللون البيج والزمردي الرسمي لجامعة البلقاء
...
```bash
python3 -m venv venv
source venv/bin/activate  # في نظام Linux أو macOS
# في نظام Windows استخدم: venv\Scripts\activate
...
افتح المتصفح على الأسطر التالية:
...
- **تشفير كلمات المرور:** تشفير `bcrypt` لحفظ بيانات الاعتماد بأمان تام.
